...
static const char qt_meta_stringdata_CProgramView[] = {
    ...
    "slot_updateTreeFinished()\0"
    "slot_DelayReAddress()\0"
};
...
void CProgramView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 12: _t->slot_updateTreeFinished(); break;
        case 13: _t->slot_DelayReAddress(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
static const uint qt_meta_data_updateTreeThread[] = {
...
static const char qt_meta_stringdata_updateTreeThread[] = {
    "updateTreeThread\0\0updateTreeFinished()\0"
};

void updateTreeThread::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        Q_ASSERT(staticMetaObject.cast(_o));
        updateTreeThread *_t = static_cast<updateTreeThread *>(_o);
        switch (_id) {
        case 0: _t->updateTreeFinished(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData updateTreeThread::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject updateTreeThread::staticMetaObject = {
    { &QThread::staticMetaObject, qt_meta_stringdata_updateTreeThread,
      qt_meta_data_updateTreeThread, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &updateTreeThread::getStaticMetaObject() { return staticMetaObject; }
#endif //Q_NO_DATA_RELOCATION

const QMetaObject *updateTreeThread::metaObject() const
{
    return QObject::d_ptr->metaObject ? QObject::d_ptr->metaObject : &staticMetaObject;
}

void *updateTreeThread::qt_metacast(const char *_clname)
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_updateTreeThread))
        return static_cast<void*>(const_cast< updateTreeThread*>(this));
    return QThread::qt_metacast(_clname);
}

int updateTreeThread::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
...
// SIGNAL 0
void updateTreeThread::updateTreeFinished()
{
    QMetaObject::activate(this, &staticMetaObject, 0, 0);
}
