...
//            CGlobal::instance()->processController()->reLogin();
        ...
        case NCT_InputEmergency:
        {
            ...
            CGlobal::instance()->processController()->addLog(Start, "开关量联动应急");
            break;
        }
        //有源输入联动应急
        case NCT_ActiveInputEmergency:
        {
            ...
            CGlobal::instance()->processController()->emergency(OBJS_InputEmergency, true);
            CGlobal::instance()->processController()->addLog(Start, "有源输入联动应急");
            break;
        }
        //无源输入联动应急
        case NCT_PassiveInputEmergency:
        {
            ...
            CGlobal::instance()->processController()->emergency(OBJS_InputEmergency, true);
            CGlobal::instance()->processController()->addLog(Start, "无源输入联动应急");
            break;
        }
        //强制启动（按键）
        case NCT_ForceEmergency:
        {
            ...
            CGlobal::instance()->processController()->addLog(Start, "系统强制启动");
            break;
        }
        //应急启动
        case NCT_EmergencyStart:
        {
            ...
            CGlobal::instance()->processController()->addLog(Start, "应急启动");
            break;
        }
        //应急停止
        case NCT_EmergencyStop:
        {
            ...
            CGlobal::instance()->processController()->addLog(Start, "应急停止");
            break;
        }
        //模拟火警点应急
