...
void CGlobal::initObjectStatusList()
{
    ...
    {
        m_emergencyStatusList<<OBJS_Emergency<<OBJS_RemoteEmergency<<OBJS_FireEmergency<<OBJS_UnknownFireEmergency<<OBJS_ForceEmergency<<OBJS_InputEmergency<<OBJS_ManualEmergency<<OBJS_DIEmergency
