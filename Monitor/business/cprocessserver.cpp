...
void CprocessServer::slot_handleNewConnection()
{
    ...
    //发送客户端数据保存到txt文件
    CGlobal::instance()->processSocket()->saveDataToTxt("/home/xfss/root/masterData.txt", str);
...
//    //清空数据监听文本
//    CGlobal::instance()->processSocket()->clearTxtData("/home/xfss/root/masterData.txt");
}
...
void CprocessServer::onSocketError(QAbstractSocket::SocketError error)
{
    if (m_tcpSocket) {
        ...
        CGlobal::instance()->processSocket()->saveDataToTxt("/home/xfss/root/masterData.txt", dataWithTimestamp);
    }
}
...
{
    //设置文档大小最大为1M
    CGlobal::instance()->processSocket()->controlTxtFileSize("/home/xfss/root/masterData.txt",1024*1024);
}
