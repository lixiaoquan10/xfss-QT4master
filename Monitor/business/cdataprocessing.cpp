    ...
    QObject(parent)
{
    ...
    m_CheckFireTime = new QTimer(this);
//    m_CheckFireTime->start(1000);
    m_isStatusTab = false;
    ...
    connect(m_CheckFireTime, SIGNAL(timeout()), this, SLOT(slot_checkFirePoint()));
...
void CDataProcessing::slot_checkFirePoint()
{
    qDebug() << "CDataProcessing::slot_checkFirePoint"
...
//                        msgObjectStatus.ndata.append(j);
//                        msgObjectStatus.ndata.append(m*63+1);
//                        CGlobal::instance()->ClientBusiness()->exeCommand(NCT_AutoFire, &msgObjectStatus);
//                    }
                }
            }
        }
...
void CDataProcessing::slotChangeColor()
{
    ...
    if(m_colorNum == 3)
    {
        ...
        //灯具状态复位
        QTimer::singleShot(10000, CGlobal::instance()->ClientBusiness(), SLOT(DeviceResetStatus()));
